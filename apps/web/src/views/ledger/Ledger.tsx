  ...
  if (libraryLoadError && titlesEmpty) {
    return (
      <div className="max-w-[1500px] mx-auto px-4 sm:px-8 pt-6 sm:pt-10">
        <DashHero />
        <div
          className="rounded-xl border border-dashed py-14 px-6 text-center"
          style={{ borderColor: 'rgba(200,90,60,0.4)' }}
        >
        ...
        {widgets.length === 0 && (
          ...
          >
            <p className="text-sm text-paper-faint">
              The board is empty. {editing ? 'Drag widgets here from the palette.' : ''}
            </p>
            {!editing && canEdit && (
              <button
                type="button"
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    isDragging || isSettling ? '0 20px 50px -12px rgba(0,0,0,0.6)' : undefined,
                }}
              >
                <div
                  className={cn(
                ...
                >
                  <Component
                    ...
                    width={compactViewport ? 'sm' : widget.width}
                  />
                </div>
                {editing && (
                  <>
